...
type PortDispositivo interface {
	...
	UpdateUltimaLectura(ctx context.Context, numeroDispositivo string, lectura *entities.LecturaDispositivo, latitud, longitud *float64) (*entities.DispositivoEntity, error)
