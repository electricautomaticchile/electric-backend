...
func registerRoutes(
	...
	featureFlagCtrl := controllers.NewFeatureFlagController(svc.FeatureFlagService)
	umbralAlertaCtrl := controllers.NewUmbralAlertaController(svc.UmbralService)
	...
	featureFlagCtrl.SetupRoutes(api)
	umbralAlertaCtrl.SetupRoutes(api)
